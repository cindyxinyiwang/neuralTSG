...
if __name__ == "__main__":
	...
	st = time.time()
	### TSG object, might need to reposition to other locations
	#T = cPickle.load(open(config['tsg_obj'], 'r'))
	T = cPickle.load(open('corpus/tsg.tsg.pkl', 'r'))
	while line != '':
		line = line.strip()
		src = line.split(' ')
		...
		if args.trans:
			...
			# translate
			result = model.translate(src_index, T)
